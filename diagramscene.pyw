...
class MainWindow(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        import customsortfiltermodel
        window = customsortfiltermodel.Window()
        window.setSourceModel(customsortfiltermodel.createMailModel(window))
        self.scene = window
    ...
    def createToolBox(self):
        ...
        layout.addWidget(self.createCellWidget(u"提交bug", DiagramItem.Conditional),
                0, 0)
        layout.addWidget(self.createCellWidget(u"查看bug", DiagramItem.Step), 1,
                0)
        ...
        self.toolBox.addItem(itemWidget, u"bug管理")
